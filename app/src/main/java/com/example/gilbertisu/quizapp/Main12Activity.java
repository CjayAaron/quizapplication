...
public class Main12Activity extends AppCompatActivity {
    ...
    public void next6(View view){
        // Toast.makeText(getApplicationContext(), "Welcome User" + Username.getText().toString(), Toast.LENGTH_LONG).show();
        Intent intent = new Intent(Main12Activity.this, Main13Activity.class);
        answer = (TextView) findViewById(R.id.ans3);
    ...
    private void display(int number) {
        TextView quantityTextView = (TextView) findViewById(R.id.score9);
    ...
    public void onBackPressed() {
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.finishAffinity(Main12Activity.this);
            }
        });
